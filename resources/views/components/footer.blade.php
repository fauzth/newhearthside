<footer class="bg-white">
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div>
          <div class="text-red-900  font-bold  ">
            ...
            <span class="self-start">
              Heartside Restaurant
            </span>
          </div>
  
          <p class="mt-4 max-w-xs text-gray-500">
            Hearthside is dedicated to providing the best culinary experience with quality dishes and friendly service. We always strive to create a cozy and warm atmosphere for every guest who comes.
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
          <div>
            ...
            <ul class="mt-6 space-y-4 text-sm">
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Delivery Order </a>
              </li>
  
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Dine In </a>
              </li>
  
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Take Away</a>
              </li>
  
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Catering </a>
              </li>
  
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Drive Thru </a>
              </li>
            </ul>
          </div>
      ...
      <p class="text-xs text-gray-500">&copy; 2024. Hearthside Steakhouse. All rights reserved.</p>
    </div>
  </footer>